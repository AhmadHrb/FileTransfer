...
<head>
    ...
    <title>Upload - File Transfer</title>
</head>
...
<div class="container">
    <center>
        <form method="post" action="upload.php" enctype="multipart/form-data">
            ...
            <br>
            <br>
        <button class="btn btn-primary"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-arrow-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
